...
def main():
    ...
    print("╔" + "═" * 68 + "╗")
    print("║" + " " * 15 + "M7 ROBUSTNESS TESTING SUITE" + " " * 26 + "║")
    print("║" + " " * 68 + "║")
    print("║" + "  Milestone 7: Validating System Robustness" + " " * 26 + "║")
    print("║" + "  Week 13-14 Deliverable" + " " * 44 + "║")
    print("╚" + "═" * 68 + "╝")
    print()
    ...
    print(f"║  Taxonomy-off test:     {status_1:<45} ║")
    print(f"║  Unit-noise test:       {status_2:<45} ║")
    print(f"║  Report generation:     {status_3:<45} ║")
    print("╚" + "═" * 68 + "╝")
    print()
